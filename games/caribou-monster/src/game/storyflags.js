...
export const FLAGS = {
  ...
  PSYDUCKS: 'psyducks',
  CELESTIC: 'celestic',
  CELESTIC_READ: 'celesticRead',
  LAKE_VERITY: 'lakeVerity',
  READ_VOLUME_1: 'readVolume1',
  READ_VOLUME_2: 'readVolume2',
  READ_VOLUME_3: 'readVolume3',
  CANALAVE_TRUTH: 'canalaveTruth',
  RILEY_DONE: 'rileyDone',
  BUDDY_HAS_STARTER: 'buddyHasStarter',
...
export const SHARED_MILESTONES = [
  FLAGS.BUDDY_JOINED, FLAGS.GOT_STARTER, FLAGS.LEFT_TOWN, FLAGS.ENTERED_FOREST, FLAGS.FOREST_GRUNT,
  FLAGS.REACHED_ALDERMERE, FLAGS.BADGE_1, FLAGS.ENTERED_CAVE, FLAGS.BEAT_COMMANDER,
  FLAGS.GALACTIC_HQ, FLAGS.LAKE_VALOR, FLAGS.CELESTIC, FLAGS.LAKE_VERITY, FLAGS.CANALAVE_TRUTH,
