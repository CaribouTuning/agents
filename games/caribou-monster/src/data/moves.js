...
add({ id: 'recover', name: 'Recover', type: 'Normal', power: 0, acc: 0, pp: 5, cls: 'status', priority: 0, crit: 0, effect: { kind: 'heal', fraction: 0.5 }, flags: [], tm: -1 });
...
add({ id: 'softboiled', name: 'Soft-Boiled', type: 'Normal', power: 0, acc: 0, pp: 5, cls: 'status', priority: 0, crit: 0, effect: { kind: 'heal', fraction: 0.5 }, flags: [], tm: -1 });
...
add({ id: 'rest', name: 'Rest', type: 'Psychic', power: 0, acc: 0, pp: 5, cls: 'status', priority: 0, crit: 0, effect: null, flags: [], tm: 44 });
...
add({ id: 'milkdrink', name: 'Milk Drink', type: 'Normal', power: 0, acc: 0, pp: 5, cls: 'status', priority: 0, crit: 0, effect: { kind: 'heal', fraction: 0.5 }, flags: [], tm: -1 });
...
add({ id: 'stockpile', name: 'Stockpile', type: 'Normal', power: 0, acc: 0, pp: 20, cls: 'status', priority: 0, crit: 0, effect: { kind: 'multistat', target: 'self', stats: ['def', 'spd'], stages: 1 }, flags: [], tm: -1 });
...
add({ id: 'memento', name: 'Memento', type: 'Dark', power: 0, acc: 100, pp: 10, cls: 'status', priority: 0, crit: 0, effect: { kind: 'multistat', target: 'foe', stats: ['atk', 'spa'], stages: -2 }, flags: [], tm: -1 });
...
add({ id: 'lusterpurge', name: 'Luster Purge', type: 'Psychic', power: 95, acc: 100, pp: 5, cls: 'special', priority: 0, crit: 0, effect: { kind: 'stat', target: 'foe', stat: 'spd', stages: -1, chance: 0.5 }, flags: [], tm: -1 });
add({ id: 'mistball', name: 'Mist Ball', type: 'Psychic', power: 95, acc: 100, pp: 5, cls: 'special', priority: 0, crit: 0, effect: { kind: 'stat', target: 'foe', stat: 'spa', stages: -1, chance: 0.5 }, flags: [], tm: -1 });
...
add({ id: 'slackoff', name: 'Slack Off', type: 'Normal', power: 0, acc: 0, pp: 5, cls: 'status', priority: 0, crit: 0, effect: { kind: 'heal', fraction: 0.5 }, flags: [], tm: -1 });
...
add({ id: 'roost', name: 'Roost', type: 'Flying', power: 0, acc: 0, pp: 5, cls: 'status', priority: 0, crit: 0, effect: { kind: 'heal', fraction: 0.5 }, flags: [], tm: 51 });
...
add({ id: 'defog', name: 'Defog', type: 'Flying', power: 0, acc: 0, pp: 15, cls: 'status', priority: 0, crit: 0, effect: { kind: 'stat', target: 'foe', stat: 'eva', stages: -1 }, flags: [], tm: 105 });
