...
const MATTHEW_HOUSE = defineMap('matthew_house', {
  ...
  events: [
    { x: 5, y: 6, flag: 'mumSentYouOff', script: 'mumDoor' },
    { x: 6, y: 6, flag: 'mumSentYouOff', script: 'mumDoor' },
  ],
  npcs: [
    {
      ...
      dialogue: [
        {
          ...
          pool: [
            ['She has not slept properly since. Not worried — busy.',
              'Thirty-one years of readings, and the last four days of them\nare the only ones that make sense.',
            ...
            ['The light readings went flat the day you came back up.',
              'Flat everywhere, for the first time since the instruments\nwere invented. She has a wall of it.',
        ...
        },
        {
          ...
          lines: ['Both of you walked out of here with one. She has been in a good\nmood since, which is unnerving.',
            'She says two trainers who start the same morning end up\nmeasuring themselves against each other.',
      ...
      dialogue: [
        {
          ...
          lines: ['You took the Coal Badge off Roark! I saw it!',
            ...
            'The rest of the Gyms after this one, and then the League.'],
        },
        {
          lines: ['Hey! You here to challenge the Gym? Let me give you the rundown.',
            ...
            '{leagueBadges} badges gets you into the Pokémon League. That is the whole road.',
