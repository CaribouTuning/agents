...
export const HEARTHOME = defineMap('hearthome', {
  ...
  warps: [
    ...
    { x: 12, y: 25, to: 'amity_square', tx: 9, ty: 13, dir: 'up' },
    { x: 13, y: 25, to: 'amity_square', tx: 10, ty: 13, dir: 'up' },
  ],
  labels: [
...
export const AMITY_SQUARE = defineMap('amity_square', {
  ...
  warps: [
    { x: 9, y: 14, to: 'hearthome', tx: 12, ty: 26, dir: 'down' },
    { x: 10, y: 14, to: 'hearthome', tx: 13, ty: 26, dir: 'down' },
  ],
  signs: [
