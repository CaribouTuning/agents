...
export const TWINLEAF = defineMap('twinleaf', {
  ...
  // The pond behind the houses. Small things, and not many of them: this is
  // a village pond, not a lake, and the first fish anybody here ever caught
  // came out of it.
  encounters: {
    fish: { min: 2, max: 6, table: [[129, 60], [118, 30], [283, 10]] },
    surf: { min: 3, max: 7, table: [[129, 70], [118, 30]] },
  },
  ...
  npcs: [
    ...
    // standing next to it rather than being a wall that talks.
    {
      ...
      dialogue: [
        ...
        {
          when: { badges: 1 },
          lines: ['Steward: The Circuit wants all {leagueBadges} badges.\nYou have {badges}.',
            'Steward: Not a judgement. It is just the door I am paid to hold.'],
        },
        {
          lines: ['Steward: Battle Hall. Circuit members only.',
            'Steward: Come back with all {leagueBadges} Gym badges\nand the door is yours.'],
        },
      ],
    },
    {
...
export const JUBILIFE = defineMap('jubilife', {
  ...
  tiles: [
    ...
    'T.....qqqtqqqqqqqqqtq...q.......TT',
    'T.....qqqqqqqqqqqqqqqqqqqq.......T',
    'T.........T....qq.T..............T',
    'T..hihih.......lq....hihih.......T',
    'TT.hhihh.......qq....hhihh...T...T',
    'T..#WDW#.......qq....#WDW#.......T',
    'T.T...q.....T..qq...T..q.........T',
    'T.....qqqqqqqqqqqqqqqqqq.......T.T',
    'T..S.....T.....qq....T......S....T',
    'T.qqqqqqqqqqqqqqqqqqqqqqqqqq.....T',
    'T.hhihhihhqtqqqqqqtqhhihhihh.....T',
    'T.#WDW#WDWqqyq0qqyqq#WDW#WDW..T..T',
    'T.qq.qq.qqqqqqqqqqqqqq.qq.qq.....T',
    'TTTTTTTTTTTTqqqqqqTTTTTTTTTTTTTTTT',
  ],
  // The pond in the park behind the Mart. A city park pond is stocked, and
  // an audit rule says a stretch of water you can cast into has to have
  // something living in it.
  encounters: {
    fish: { min: 8, max: 14, table: [[129, 50], [118, 26], [119, 14], [283, 10]] },
    surf: { min: 8, max: 14, table: [[129, 60], [118, 24], [119, 16]] },
  },
  warps: [
