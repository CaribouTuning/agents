...
import {
  ROUTE209, LOST_TOWER, LOST_TOWER_2, LOST_TOWER_3, SOLACEON, SOLACEON_RUINS,
  ROUTE210, ROUTE215, VEILSTONE, VEILSTONE_GYM, SOLACEON_CENTER, SOLACEON_HOUSE,
  VEILSTONE_CENTER, VEILSTONE_STORE, GALACTIC_WAREHOUSE, GALACTIC_HQ,
} from './east.js';
import {
  ROUTE212, PASTORIA, GREAT_MARSH, PASTORIA_GYM, ROUTE213, ROUTE214,
...
const ALL = [TWINLEAF, ROUTE201, SANDGEM, ROUTE202, JUBILIFE, ROUTE203, OREBURGH,
  ...
  MT_CORONET_SOUTH, ROUTE208, HEARTHOME, HEARTHOME_GYM, HEARTHOME_CENTER,
  HEARTHOME_MART, CONTEST_HALL, AMITY_SQUARE,
  // North and east: the graveyard road, Solaceon, and the city Galactic
  // built a headquarters in.
  ROUTE209, LOST_TOWER, LOST_TOWER_2, LOST_TOWER_3, SOLACEON, SOLACEON_RUINS,
  ROUTE210, ROUTE215, VEILSTONE, VEILSTONE_GYM, SOLACEON_CENTER, SOLACEON_HOUSE,
  VEILSTONE_CENTER, VEILSTONE_STORE, GALACTIC_WAREHOUSE, GALACTIC_HQ,
  // The wet south, and the lake they got to first.
  ROUTE212, PASTORIA, GREAT_MARSH, PASTORIA_GYM, ROUTE213, ROUTE214,
  VALOR_LAKEFRONT, LAKE_VALOR, PASTORIA_CENTER, LAKEFRONT_CENTER,
  ...INTERIORS];
