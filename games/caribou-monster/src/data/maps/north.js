...
export const ETERNA_FOREST = defineMap('eterna_forest', {
  ...
  warps: [
    ...
    { x: 9, y: 0, to: 'eterna', tx: 14, ty: 20, dir: 'up', edge: true },
    { x: 10, y: 0, to: 'eterna', tx: 15, ty: 20, dir: 'up', edge: true },
  ],
  signs: [],
  objects: [
...
export const ETERNA = defineMap('eterna', {
  ...
  warps: [
    { x: 12, y: 21, to: 'eterna_forest', tx: 9, ty: 1, dir: 'down', edge: true },
    { x: 13, y: 21, to: 'eterna_forest', tx: 10, ty: 1, dir: 'down', edge: true },
    { x: 29, y: 7, to: 'route206', tx: 1, ty: 6, dir: 'right', edge: true },
...
export const ROUTE206 = defineMap('route206', {
  ...
  warps: [
    { x: 0, y: 6, to: 'eterna', tx: 28, ty: 7, dir: 'left', edge: true },
